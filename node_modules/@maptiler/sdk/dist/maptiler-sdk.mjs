...
class qr {
  ...
  static parse(e, t) {
    ...
    const n = t.parse(e[1], 1, b), a = t.parse(e[2], 2, Z(t.expectedType || T));
    if (!n || !a)
      return null;
    const o = a.type;
